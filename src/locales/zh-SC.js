const zhSC = {
  ...
  workflowDesigner: {
    ...
    timeValidator: {
      ...
      retryMessageRecipients: '提醒消息收件人',
      retryMessageRecipientsDescription: '选择需要接收提醒消息的人员（可选择用户、联系人、流程变量或流程启动人）：',
      ...
      retryMessageCleared: '提醒消息配置已清除',
      escalationCleared: '升级通知配置已清除',
      overdueEscalationCleared: '逾期升级通知配置已清除',
      overdueEscalationRecipients: '逾期升级通知收件人',
      overdueEscalationRecipientsDescription: '选择在流程逾期后，需要接收升级通知的人员：',
      overdueEscalationMessage: '逾期升级通知消息',
      overdueEscalationMessageDescription: '设置当流程逾期后，发送给升级对象的通知消息：',
      overdueEscalationMessagePlaceholder: '请输入逾期升级通知消息内容...',
      overdueEscalationMessageTip: '提示：此消息会在流程超过逾期时间后发送',
    },
    ...
    templateHeaderUrlHelp: '支持使用流程变量，例如：${InvoiceNo}。运行时会自动替换为实际值。',
    templateImageSource: '图片来源',
    templateImageSourceUrl: '使用 URL',
    templateImageSourceInstance: '使用流程实例图片',
    templateImageSourceHelp: '选择使用 URL 或当前流程实例文件夹中的图片（自动排除 qr_scan_success_* 文件，如有多张图片则使用最早的一张）。',
    templateDocumentFilename: '文件名称',
    templateDocumentFilenamePlaceholder: '例如：${InvoiceNo}.pdf',
    templateDocumentFilenameHelp: '支持使用流程变量，例如：${InvoiceNo}。运行时会自动替换为实际值。',
    formInfo: '表单信息',
    formId: '表单ID：',
    formName: '表单名称：',
    formDescription: '描述：',
  ...
  workflowDesigner: {
    ...
    email: {
      provider: '邮件服务提供商',
      providerRequired: '请选择邮件服务提供商',
      selectProvider: '选择邮件服务提供商',
      noProviderConfigured: '未配置邮件服务提供商。请在 API 管理中添加。',
      subject: '邮件主题',
      subjectRequired: '请输入邮件主题',
      subjectPlaceholder: '输入邮件主题',
      body: '邮件内容',
      bodyRequired: '请输入邮件内容',
      bodyPlaceholder: '输入邮件内容（支持流程变量，如 ${variableName}）',
      bodyHelp: '您可以在邮件内容中使用流程变量。点击上方的变量标签即可插入。支持富文本格式（粗体、斜体、颜色等）。'
    },
  ...
  apiProviders: {
    ...
    messages: {
      ...
      validationFailed: '表单验证失败，请检查输入内容。'
    },
    ...
    description: {
      ...
      'copilot': 'Copilot Chat API（需企业授权）',
      'gemini': 'Google AI Gemini API',
      'google-docs': 'Google Docs 读写 API（Dataset 导入、文档同步）',
      'microsoft-graph': '使用 Microsoft Graph API 通过 Office 365 发送电子邮件，需要 OAuth 2.0 认证与 Mail.Send 权限。'
    },
    status: {
      active: '启用',
      inactive: '停用',
    ...
    form: {
      ...
      apiUrlEmailServerTip: 'Microsoft Graph API URL 中的 {userPrincipalName} 会在发送邮件时自动替换为发件人的 email 地址。',
      model: '模型',
      ...
      authConfigJsonEmailServer: 'OAuth 2.0 授权配置 (JSON)',
      authConfigTipEmailServer: 'Microsoft Graph API 需要 OAuth 2.0 认证，请输入 JSON 格式：{"tenantId":"your-tenant-id","clientId":"your-client-id","clientSecret":"your-client-secret"}',
      oauthConfig: 'OAuth 2.0 认证设置',
      tenantId: 'Tenant ID',
      tenantIdRequired: '请输入 Tenant ID',
      tenantIdTip: 'Azure AD 租户 ID，可在 Azure Portal 中找到',
      clientId: 'Application (client) ID',
      clientIdRequired: '请输入 Application (client) ID',
      clientIdTip: '应用程序 (客户端) ID，可在 Azure Portal 的应用程序注册中找到',
      clientSecret: 'Client Secret',
      clientSecretRequired: '请输入 Client Secret',
      clientSecretTip: '应用程序密钥值，可在 Azure Portal 的应用程序注册中创建',
      emailSettings: '邮件发送设置',
      fromEmail: '发件人电子邮件',
      fromEmailRequired: '请输入发件人电子邮件地址',
      fromEmailInvalid: '请输入有效的电子邮件地址',
      fromEmailTip: '发送邮件时使用的发件人地址',
      replyTo: '回复地址',
      replyToInvalid: '请输入有效的电子邮件地址',
      replyToTip: '收件人回复时使用的地址（可选）',
      saveToSentItems: '保存到已发送项目',
      saveToSentItemsTip: '是否将发送的邮件保存到发件人的已发送项目文件夹',
      enabled: '启用',
      disabled: '停用',
      testEmail: '发送测试邮件',
      testEmailModalTitle: '发送测试邮件',
      sendTestEmail: '发送',
      testEmailTo: '收件人',
      testEmailToRequired: '请输入收件人地址',
      testEmailToInvalid: '请输入有效的电子邮件地址',
      testEmailToTip: '测试邮件将发送到此地址',
      testEmailSubjectLabel: '邮件主题',
      testEmailSubject: 'WhattoFlow 邮件发送测试',
      testEmailSubjectRequired: '请输入邮件主题',
      testEmailBodyLabel: '邮件内容',
      testEmailBody: '这是一封测试邮件，用于验证 Microsoft Graph API 邮件发送配置是否正确。',
      testEmailBodyRequired: '请输入邮件内容',
      testEmailSuccess: '测试邮件发送成功！请检查收件箱。',
      testEmailFailed: '测试邮件发送失败，请检查配置。',
      testEmailValidationError: '请先填写必要的配置字段（Tenant ID、Client ID、Client Secret、发件人地址）。',
      settingsJson: '进阶设置 (JSON)',
      settingsJsonTip: '自定义供应商专属参数，例如 temperature、top_p、top_k。',
      settingsJsonEmailServer: '邮件设置 (JSON)',
      settingsJsonTipEmailServer: '邮件发送相关设置，例如：{"fromEmail":"sender@example.com","replyTo":"reply@example.com","saveToSentItems":true}',
