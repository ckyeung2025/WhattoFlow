const zhTC = {
  ...
  workflowDesigner: {
    ...
    templateId: '模板ID：',
    templateName: '模板名稱：',
    // 模板 Image/Document URL 配置
    templateImageUrl: '圖片 URL',
    templateDocumentUrl: '文件 URL',
    templateImageUrlPlaceholder: '例如：https://example.com/images/${InvoiceNo}.jpg',
    templateDocumentUrlPlaceholder: '例如：https://example.com/pdf/${InvoiceNo}.pdf',
    templateHeaderUrlHelp: '支持使用流程變量，例如：${InvoiceNo}。運行時會自動替換為實際值。',
    templateImageSource: '圖片來源',
    templateImageSourceUrl: '使用 URL',
    templateImageSourceInstance: '使用流程實例圖片',
    templateImageSourceHelp: '選擇使用 URL 或當前流程實例文件夾中的圖片（自動排除 qr_scan_success_* 文件，如有多張圖片則使用最早的一張）。',
    templateDocumentFilename: '文件名稱',
    templateDocumentFilenamePlaceholder: '例如：${InvoiceNo}.pdf',
    templateDocumentFilenameHelp: '支持使用流程變量，例如：${InvoiceNo}。運行時會自動替換為實際值。',
    formInfo: '表單信息',
    formId: '表單ID：',
    formName: '表單名稱：',
    formDescription: '描述：',
