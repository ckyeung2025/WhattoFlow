const zhTC = {
  ...
  workflowMonitor: {
    ...
    // 圖片相關
    loadingImages: '載入圖片中...',
    noImagesReceived: '暫無接收的圖片',
    imagePreview: '圖片預覽',
    previewImage: '預覽圖片',
    downloadImage: '下載圖片',
    imageLoadFailed: '圖片載入失敗',
    imageStatusSuccess: '成功',
    imageStatusFailed: '失敗',
    imageStatusProcessing: '處理中',
    imageStatusPending: '等待中',
    imagesApiNotExists: '圖片 API 不存在',
    imagesApiNotImplemented: '圖片 API 尚未實現',
    loadImagesFailed: '載入圖片失敗',
    loadedImagesData: '已載入圖片數據',
    loadingImagesData: '正在載入圖片數據',
    previousImage: '上一張圖',
    nextImage: '下一張圖',
    flipVertical: '垂直翻轉',
    flipHorizontal: '水平翻轉',
