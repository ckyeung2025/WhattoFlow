const en = {
  ...
  menu: {
    ...
    realtimeReports: 'Realtime Reports',
  },
  ...
  companyUserAdmin: {
    ...
    no: "No",
    editUser: "Edit User",
    mainAccountNote: "(In SaaS version, main account refers to payment account)",
    password: "Password",
    passwordPlaceholder: "Enter new password to change (leave empty to keep current)",
  ...
  companyEdit: {
    ...
    waBusinessAccountIdTooltip: "Used for managing Meta official templates",
    waBusinessAccountIdSuffix: "Template Management",
    phoneNoIdPlaceholder: "e.g.: 690383010830837",
    businessAccountIdPlaceholder: "e.g.: 1102096678464098",
    configWarningTitle: "⚠️ Important Configuration Reminder",
    configWarningDescription: "Please ensure Phone Number ID belongs to the WABA specified by Business Account ID:",
    configWarningPhoneIdUse: "• Phone Number ID is used for sending messages (must belong to the correct WABA)",
    configWarningBusinessIdUse: "• Business Account ID is used for querying template list",
    configWarningMismatchTitle: "⚠️ If these two IDs do not match, it will lead to:",
    configWarningMismatchItem1: "Can see template list, but cannot find template when sending messages",
    configWarningMismatchItem2: "Templates belong to different WABAs and cannot be used",
    configWarningSolution: "💡 Solution: In Meta Business Suite, confirm which WABA the Phone Number ID belongs to, then update Business Account ID to that WABA's ID",
    ...
    validateTokenCheckResult: "🔐 Token Permission Check Result",
    tokenStatus: "Token Status:",
    tokenValid: "✅ Valid",
    tokenInvalid: "❌ Invalid",
    companyLabel: "Company:",
    capabilitiesTitle: "Capabilities:",
    sendMessageLabel: "Send Messages:",
    available: "✅ Available",
    unavailable: "❌ Unavailable",
    receiveWebhookLabel: "Receive Webhooks:",
    manageTemplatesLabel: "Manage Meta Templates:",
    createFlowLabel: "Create WhatsApp Flow:",
    permissionsTitle: "Detailed Permissions:",
    recommendationsTitle: "Recommendations:",
    permissionCheckFailed: "Unable to validate Token permissions, please check your settings",
    validateTokenPermissionError: "Error occurred while checking Token permissions, please try again later",
    validateTokenCheckError: "Error occurred while checking Token permissions, please try again later",
    apiKeyRequired: "Please enter WA API Key (Access Token) first",
    businessAccountIdRequired: "Please enter WhatsApp Business Account ID first",
    webhookToken: "Webhook Token",
    webhookTokenPlaceholder: "Auto-generated unique Token",
    regenerateToken: "Regenerate",
    tokenGenerated: "New Token generated, URL updated",
    webhookUrl: "Meta Webhook URL",
    webhookUrlPlaceholder: "e.g.: https://your-domain.com/api/MetaWebhook/your-token",
    copyWebhookUrl: "Copy",
    webhookUrlCopied: "Webhook URL copied to clipboard",
    generateTokenFirst: "Please generate Webhook Token first",
    ...
    // Placeholders
    welcomeMessagePlaceholder: "Welcome to our service!\n\nPlease select the feature you need:",
    noFunctionMessagePlaceholder: "Welcome to our service!\n\nNo features available at the moment, please contact the administrator.",
    menuTitlePlaceholder: "Service Menu",
    menuButtonPlaceholder: "View Options",
    menuFooterPlaceholder: "Please select the service you need",
    sectionTitlePlaceholder: "Service Options",
    defaultOptionDescriptionPlaceholder: "Click to select this service",
    inputErrorMessagePlaceholder: "Input is incorrect, please re-enter.",
    fallbackMessagePlaceholder: "\n\nReply with a number to select a feature, or type \"Menu\" to show the menu again.",
    systemErrorMessagePlaceholder: "System error: Unable to find QR Code node configuration."
  },
  ...
  whatsappTemplate: {
    ...
    metaTemplate: {
      ...
      category: "Category",
      language: "Language",
      headerOptional: "Media Example · Optional",
      headerNone: "None",
      headerText: "Text",
      headerImage: "Image",
      headerVideo: "Video",
      ...
      dragOrClickToUpload: "Drag and drop files to upload, or choose files from your device",
      imageUploadHint: "Supports JPG, PNG, GIF, BMP, WEBP formats",
      videoUploadHint: "Supports MP4, AVI, MOV, WMV formats",
      documentUploadHint: "Supports PDF, DOC, DOCX, TXT formats",
      orEnterUrl: "Or enter file URL",
      urlHelp: "If the file is already uploaded elsewhere, you can directly enter the URL",
      enterFileUrl: "Please enter file URL (e.g.: https://example.com/image.jpg)",
      fileUploadInDevelopment: "File upload feature is under development, please use URL method for now",
      pleaseUploadFileOrUrl: "Please upload a file or provide a file URL",
      dataUrlNotSupported: "Meta API does not accept data URL (base64) format, please use actual HTTP/HTTPS URL",
      urlMustBeHttp: "URL must be HTTP or HTTPS protocol",
      invalidUrlFormat: "Invalid URL format",
      uploadingFile: "Uploading file...",
      fileUploadFailed: "File upload failed",
      localhostNotAccessible: "Warning: Meta API cannot access localhost or local IP addresses. Please use a publicly accessible URL or upload the file to a public server.",
  ...
  workflowDesigner: {
    ...
    timeValidator: {
      retryInterval: 'Reminder Interval',
      retryIntervalHelp: 'If user does not respond within this time, system will automatically resend the reminder message',
      retryLimit: 'Reminder Limit',
      retryMessage: 'Reminder Message Settings',
      escalation: 'Escalation Settings',
      configureRetryMessage: 'Configure Reminder Message',
      configureEscalation: 'Configure Escalation',
      ...
      escalationMessagePlaceholder: 'Enter escalation notification message content to inform managers that action is needed...',
      escalationMessageTip: 'Tip: This message will only be sent once when the reminder limit is reached',
      escalationRecipients: 'Escalation Recipients',
      escalationRecipientsDescription: 'Select the personnel who need to receive escalation notifications when the reminder limit is reached:',
      ...
      retryMessageCleared: 'Reminder message configuration cleared',
      escalationCleared: 'Escalation configuration cleared',
      overdueEscalationCleared: 'Overdue escalation configuration cleared',
      ...
      overdueEscalationRecipients: 'Overdue Escalation Recipients',
      overdueEscalationRecipientsDescription: 'Select personnel who need to receive overdue escalation notifications:',
      overdueEscalationMessage: 'Overdue Escalation Message',
      overdueEscalationMessageDescription: 'Set the notification message to be sent to escalation recipients when the workflow is overdue:',
      overdueEscalationMessagePlaceholder: 'Enter overdue escalation notification message content...',
      overdueEscalationMessageTip: 'Tip: This message will be sent when the workflow exceeds the overdue duration',
    },
    ...
    overdue: {
      enabled: 'Enable Overdue Monitoring',
      duration: 'Overdue Threshold',
      escalation: 'Overdue Notification Settings',
      configureEscalation: 'Configure Overdue Notification',
      durationHelp: 'If workflow is still running after this time from start, an overdue notification will be sent',
      escalationRecipients: 'Overdue Notification Recipients',
      escalationRecipientsDescription: 'Select personnel who need to receive notifications when workflow is overdue:',
      escalationMessage: 'Overdue Notification Message',
      escalationMessageDescription: 'Set the notification message to be sent to managers when workflow is overdue:',
      escalationMessagePlaceholder: 'Enter overdue notification message content to inform managers that workflow is overdue and needs attention...',
      escalationMessageTip: 'Tip: This message will be sent once when workflow becomes overdue',
      escalationSaved: 'Overdue notification configuration saved',
      howItWorks: 'How It Works',
      description1: 'System periodically checks all running workflows and calculates time elapsed since start',
      description2: 'When time exceeds the threshold (days + hours) and workflow is still running (not Complete or Failed), overdue notification is sent',
      description3: 'Overdue notification is sent only once to avoid repeated interruptions',
    },
    ...
    webhookDescription3: 'Webhook Token is configured at company level, workflow will automatically use company\'s webhook settings',
    ...
    email: {
      ...
      providerRequired: 'Please select an email provider',
      selectProvider: 'Select Email Provider',
      noProviderConfigured: 'No email provider configured. Please add one in API Management.',
      subject: 'Email Subject',
      subjectRequired: 'Please enter email subject',
      subjectPlaceholder: 'Enter email subject',
      body: 'Email Body',
      bodyRequired: 'Please enter email body',
      bodyPlaceholder: 'Enter email body content (supports process variables like ${variableName})',
      bodyHelp: 'You can use process variables in the email body. Click on the variable tags above to insert them. Rich text formatting (bold, italic, colors, etc.) is supported.'
    },
    ...
    templateName: 'Template Name:',
    // Template Image/Document URL Configuration
    templateImageUrl: 'Image URL',
    templateDocumentUrl: 'Document URL',
    templateImageUrlPlaceholder: 'e.g.: https://example.com/images/${InvoiceNo}.jpg',
    templateDocumentUrlPlaceholder: 'e.g.: https://example.com/pdf/${InvoiceNo}.pdf',
    templateHeaderUrlHelp: 'Supports process variables, e.g.: ${InvoiceNo}. Will be replaced with actual values at runtime.',
    templateImageSource: 'Image Source',
    templateImageSourceUrl: 'Use URL',
    templateImageSourceInstance: 'Use Instance Image',
    templateImageSourceHelp: 'Select to use a URL or an image from the current workflow instance folder (excludes qr_scan_success_* files, uses the earliest image if multiple exist).',
    templateDocumentFilename: 'Filename',
    templateDocumentFilenamePlaceholder: 'e.g.: ${InvoiceNo}.pdf',
    templateDocumentFilenameHelp: 'Supports process variables, e.g.: ${InvoiceNo}. Will be replaced with actual values at runtime.',
    formInfo: 'Form Information',
    formId: 'Form ID:',
    formName: 'Form Name:',
  ...
  // Workflow Monitor
    ...
    // MessageSendStatusModal translations
    messageSendStatus: 'Message Send Status',
    loadingMessageSendRecords: 'Loading message send records...',
    loadMessageSendRecordsFailed: 'Failed to load message send records',
    normalSend: 'Normal Send',
    retrySend: 'Reminder Send',
    escalationNotification: 'Escalation Notification',
    normalSendRecords: 'Normal Message Send Records',
    retrySendRecords: 'Reminder Message Send Records',
    escalationSendRecords: 'Escalation Message Send Records',
    ...
    sendReasonNormal: 'Normal Send',
    sendReasonRetry: 'Reminder Send',
    sendReasonEscalation: 'Escalation Notification',
    sendReasonOverdue: 'Overdue Notification',
    status: 'Status',
    totalRecipients: 'Total Recipients',
    successCount: 'Success Count',
    ...
    startTime: 'Start Time',
    viewDetails: 'View Details',
    noMessageSendRecords: 'No message send records',
    recipientDetails: 'Recipient Details',
    recipient: 'Recipient',
    whatsAppMessageId: 'WhatsApp Message ID',
    sendTime: 'Send Time',
  ...
  workflowList: {
    ...
    deleteWithRelatedRecords: 'Delete workflow and related records',
    confirmDeleteWithRelatedRecords: 'Are you sure you want to delete workflow "{name}"?',
    relatedRecordsWillBeDeleted: 'Deleting this workflow will also delete the following related records:',
    executionInstances: 'Execution instances',
    stepExecutions: 'Step execution records',
    messageSends: 'Message send records',
    messageRecipients: 'Message recipient records',
    queryResults: 'Dataset query results',
    queryRecords: 'Dataset query records',
    eformInstances: 'Form instances',
    messageValidations: 'Message validation records',
    chatMessages: 'Chat messages',
    processVariableValues: 'Process variable values',
    processVariableDefinitions: 'Process variable definitions',
    noRelatedRecords: 'This workflow has no related records and can be deleted directly.',
  ...
  contactImport: {
    ...
    noPreviewData: 'Unable to load preview data, you can manually edit field mapping',
  ...
  apiProviders: {
    ...
    description: {
      'xai': 'Elon AI Grok official API',
      'openai': 'OpenAI Chat Completions',
      'deepseek': 'DeepSeek official Chat API',
      'copilot': 'Copilot Chat API (requires enterprise license)',
      'gemini': 'Google AI Gemini API',
      'google-docs': 'Google Docs read/write API (Dataset import, document sync)',
      'microsoft-graph': 'Send emails via Office 365 using Microsoft Graph API. Requires OAuth 2.0 authentication and Mail.Send permission.'
    },
    status: {
      active: 'Active',
      inactive: 'Inactive',
    ...
    form: {
      ...
      apiUrlEmailServerTip: 'The {userPrincipalName} placeholder in Microsoft Graph API URL will be automatically replaced with the sender\'s email address when sending emails.',
      model: 'Model',
      ...
      authConfigJsonEmailServer: 'OAuth 2.0 Configuration (JSON)',
      authConfigTipEmailServer: 'Microsoft Graph API requires OAuth 2.0 authentication. Enter JSON format: {"tenantId":"your-tenant-id","clientId":"your-client-id","clientSecret":"your-client-secret"}',
      oauthConfig: 'OAuth 2.0 Authentication Settings',
      tenantId: 'Tenant ID',
      tenantIdRequired: 'Please enter Tenant ID',
      tenantIdTip: 'Azure AD tenant ID, can be found in Azure Portal',
      clientId: 'Application (client) ID',
      clientIdRequired: 'Please enter Application (client) ID',
      clientIdTip: 'Application (client) ID, can be found in Azure Portal app registration',
      clientSecret: 'Client Secret',
      clientSecretRequired: 'Please enter Client Secret',
      clientSecretTip: 'Application secret value, can be created in Azure Portal app registration',
      emailSettings: 'Email Sending Settings',
      fromEmail: 'From Email Address',
      fromEmailRequired: 'Please enter from email address',
      fromEmailInvalid: 'Please enter a valid email address',
      fromEmailTip: 'Email address to use as sender',
      replyTo: 'Reply To Address',
      replyToInvalid: 'Please enter a valid email address',
      replyToTip: 'Email address for replies (optional)',
      saveToSentItems: 'Save to Sent Items',
      saveToSentItemsTip: 'Whether to save sent emails to sender\'s Sent Items folder',
      enabled: 'Enabled',
      disabled: 'Disabled',
      testEmail: 'Send Test Email',
      testEmailModalTitle: 'Send Test Email',
      sendTestEmail: 'Send',
      testEmailTo: 'Recipient',
      testEmailToRequired: 'Please enter recipient email address',
      testEmailToInvalid: 'Please enter a valid email address',
      testEmailToTip: 'Test email will be sent to this address',
      testEmailSubjectLabel: 'Subject',
      testEmailSubject: 'WhattoFlow Email Test',
      testEmailSubjectRequired: 'Please enter email subject',
      testEmailBodyLabel: 'Body',
      testEmailBody: 'This is a test email to verify Microsoft Graph API email sending configuration.',
      testEmailBodyRequired: 'Please enter email body',
      testEmailSuccess: 'Test email sent successfully! Please check your inbox.',
      testEmailFailed: 'Test email failed. Please check your configuration.',
      testEmailValidationError: 'Please fill in required fields (Tenant ID, Client ID, Client Secret, From Email).',
      ...
      settingsJsonEmailServer: 'Email Settings (JSON)',
      settingsJsonTipEmailServer: 'Email sending configuration, e.g.: {"fromEmail":"sender@example.com","replyTo":"reply@example.com","saveToSentItems":true}',
  ...
  phoneVerification: {
    title: 'WhatsApp Phone Number Verification Management',
    pageDescription: 'Manage WhatsApp phone number verification',
    refresh: 'Refresh',
    ...
    codeExpiry: 'Verification Code Expiry',
    phoneNumberId: 'Phone Number ID',
    createdAt: 'Created At',
    actions: 'Actions',
    view: 'View',
    copyUrl: 'Copy URL',
    uploadModalTitle: 'Upload Certificate and Phone Number',
    company: 'Company',
    currentCompanyPlaceholder: 'Current Company',
    certificate: 'Digital Certificate (Base64)',
    certificateRequired: 'Please enter certificate',
    certificateFormatError: 'Certificate format may be incorrect',
    certificateHelp: 'Please copy the base64-encoded digital certificate from Meta Business Suite',
    certificatePlaceholder: 'Paste base64-encoded certificate...',
    submit: 'Submit',
    cancel: 'Cancel',
    uploadSuccess: 'Certificate uploaded',
    uploadSuccessTitle: 'Upload Successful',
    uploadSuccessMessage: 'Certificate uploaded successfully, please send the following URL to the customer:',
    verificationUrl: 'Verification URL',
    copyUrlButton: 'Copy URL',
    urlCopied: 'URL copied to clipboard',
    uploadFailed: 'Upload failed',
    loadFailed: 'Load failed',
    loadVerificationsFailed: 'Failed to load verification records',
    viewDetails: 'View Details',
    loadDetailsFailed: 'Failed to load details',
    verificationRecordDetails: 'Verification Record Details',
    verificationMethod: 'Verification Method',
    updatedAt: 'Updated At',
    errorMessage: 'Error Message',
    na: 'N/A',
    detailTitle: 'Verification Record Details',
    detailPhoneNumber: 'Phone Number:',
    detailStatus: 'Status:',
    detailCertificateExpiry: 'Certificate Expiry:',
    detailCodeExpiry: 'Verification Code Expiry:',
    detailVerificationMethod: 'Verification Method:',
    detailPhoneNumberId: 'Phone Number ID:',
    detailCreatedAt: 'Created At:',
    detailUpdatedAt: 'Updated At:',
    detailErrorMessage: 'Error Message:',
    detailVerificationUrl: 'Verification URL:',
    verificationUrlCopied: 'Verification URL copied to clipboard',
    totalRecords: 'Total {total} records',
    
    // Status labels
    statusPending: 'Pending',
    statusRequested: 'Code Requested',
    statusVerified: 'Verified',
    statusExpired: 'Expired',
    statusFailed: 'Failed',
    
    // Form validation and hints
    phoneNumberRequired: 'Please enter phone number (Company.WA_PhoneNo_ID not configured)',
    phoneNumberInvalid: 'Please enter a valid phone number (e.g., +85296062000 or 85296062000)',
    phoneNumberOptional: 'Optional: If left empty, system will automatically get from Meta API or Company.Phone',
    phoneNumberRequiredWhenNoId: 'Required: Because Company.WA_PhoneNo_ID is not configured',
    phoneNumberPlaceholderOptional: 'Optional: Leave empty to auto-get from Meta API',
    phoneNumberPlaceholderRequired: 'e.g., +85296062000 or 85296062000',
    
    // Error messages
    loadCompanyInfoFailed: 'Failed to load company information',
    cannotGetCompanyId: 'Cannot get company ID',
    cannotGetCompanyInfo: 'Cannot get company information, please login again',
    cannotLoadVerifications: 'Cannot load verification records: Company ID is empty',
    unknownError: 'Unknown error',
    
    // Country code detection
    duplicateCountryCodeDetected: 'Duplicate country code detected, automatically removed'
  },
  ...
  permissionManagement: {
    ...
    roleName: 'Role Name',
    description: 'Description',
    pageDescription: 'Manage roles and interface permissions',
    interfaces: 'Interface Permissions',
    actions: 'Actions',
    systemDefault: 'System Default',
    companyCustom: 'Company Custom',
    selectCompany: 'Select Company',
  ...
  reports: {
    noPermission: 'You do not have permission to access reports',
    loadPermissionFailed: 'Failed to load permissions',
    unauthorized: 'Unauthorized',
    noDailyReportsPermission: 'You do not have permission to access any daily reports',
    noMonthlyReportsPermission: 'You do not have permission to access any monthly reports',
    noRealtimeReportsPermission: 'You do not have permission to access any realtime reports',
    loadStatisticsFailed: 'Failed to load statistics',
    loadDataFailed: 'Failed to load report data',
    ...
    activePhoneNumbers: 'Active Phone Numbers',
    totalMessages: 'Total Messages',
    totalWorkflowTriggers: 'Total Workflow Triggers',
    ...
    formTypeUsage: 'Form Type Usage',
    formCount: 'Form Count',
    approverWorkload: 'Approver Workload',
    ...
    rejected: 'Rejected',
    hours: 'hours',
    totalProcessTypes: 'Total Process Types',
    avgEfficiency: 'Average Efficiency',
    bottleneckCount: 'Bottleneck Processes',
    optimizationSuggestions: 'Optimization Suggestions',
    processTypeDistribution: 'Process Type Distribution',
    efficiencyComparison: 'Efficiency Comparison',
    durationComparison: 'Duration Comparison',
    usageFrequencyTrend: 'Usage Frequency Trend',
    efficiencyVsDuration: 'Efficiency vs Duration',
    ...
    formUsage: 'Form Usage',
    datasetUsage: 'Dataset Usage',
    whatsappUsage: 'WhatsApp Usage',
    functionName: 'Function Name',
    usageCount: 'Usage Count',
    growthRate: 'Growth Rate',
    functionUsageDistribution: 'Function Usage Distribution',
    functionUsageTrend: 'Function Usage Trend',
    workflows: 'Workflows',
    forms: 'Forms',
    datasets: 'Datasets',
    whatsapp: 'WhatsApp',
    datasetUsageRanking: 'Dataset Usage Ranking',
    queryCount: 'Query Count',
    updateCount: 'Update Count',
    userActivityRanking: 'User Activity Ranking',
    ...
    stepName: 'Step Name',
    stepType: 'Step Type',
    stepDurationComparison: 'Step Duration Comparison',
    hourlyWorkDistribution: 'Hourly Work Distribution',
    workflowStep3D: '3D Work Distribution Visualization',
    time: 'Time',
    workflow: 'Workflow',
    step: 'Step',
    ...
    minutes: 'minutes',
    workflowSuccessRate: 'Workflow Success Rate',
    formApprovalEfficiency: 'Form Approval Efficiency',
    whatsappResponseRate: 'WhatsApp Response Rate',
    systemAvailability: 'System Availability',
    kpiTrend: 'KPI Trend Comparison',
    anomalyEvents: 'Anomaly Events Summary',
    ...
    fillTypeDistribution: 'Fill Type Distribution',
    ...
    noData: 'No data',
    topWorkflows: 'Top 10 Workflow Execution Count',
    executionCount: 'Execution Count',
    executions: 'Executions',
    durationDistribution: 'Duration Distribution',
    processingFlow: 'Processing Flow',
    fillTypeProcessingTime: 'Average Processing Time by Fill Type',
    hourlySubmissionTrend: '24-Hour Submission Trend',
    submissions: 'Submissions',
    problemWorkflows: 'Problem Workflows (Lowest Health Score Top 10)',
    successRateVsDuration: 'Success Rate vs Duration',
    definitionTypes: 'definition types',
    topActivePhoneNumbers: 'Top 20 Active Phone Numbers',
    messageTypeDistribution: 'Message Type Distribution',
    messageTypeText: 'Text',
    messageTypeImage: 'Image',
    messageTypeFile: 'File',
    messageTypeAudio: 'Audio',
    hourlyInteractionHeatmap: '24-Hour Interaction Heatmap',
    interactionVsWorkflow: 'Interaction Frequency vs Workflow Triggers',
    loginRequired: 'Please login first',
    loginExpired: 'Login expired, please login again',
    daily: {
      pendingOverview: 'Pending Tasks Overview',
      workflowExecution: 'Workflow Execution Daily',
      formEfficiency: 'Form Processing Efficiency',
      workflowHealth: 'Workflow Health Monitor',
      whatsappInteraction: 'WhatsApp Interaction Analysis'
    },
    monthly: {
      workflowPerformance: 'Workflow Performance Monthly',
      formApproval: 'Form Approval Analysis Monthly',
      businessInsights: 'Business Process Insights',
      systemUsage: 'System Usage Statistics',
      operationalOverview: 'Operational Performance Overview',
      processStepExecution: 'Process Step Execution Analysis'
    },
    realtime: {
      workflowActivity: 'Workflow Activity Kanban',
      description: 'Real-time monitoring of all running step executions (auto-updates every 3 seconds)',
      totalActive: 'Active Steps',
      running: 'Running',
      waiting: 'Waiting',
      completed: 'Completed',
      failed: 'Failed',
      noActiveWorkflows: 'No active workflows at the moment',
      noActiveSteps: 'No active step executions at the moment',
      noItems: 'No items',
      selectWorkflow: 'Select Workflow Definition',
      allWorkflows: 'All Workflows',
      dateRange: 'Date Range:',
      ...
      failedAlert: '{count} workflow executions failed, please handle promptly',
      userReplies: 'User Replies:'
    },
    actionType: {
      startWorkflow: 'Start Workflow',
      replyQrcode: 'Reply QR Code',
      replyMsg: 'Reply Message',
      receiveNotification: 'Receive Notification',
      receiveEform: 'Receive Form',
      fillEform: 'Fill Form',
