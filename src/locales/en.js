const en = {
  ...
  broadcastSend: {
    ...
    description: 'Send broadcast messages to contact groups',
    broadcastSettings: 'Broadcast Settings',
    messageContent: 'Message Content',
    messagePlaceholder: 'Please enter the message content to send...',
    previewTarget: 'Preview Target',
    sendBroadcast: 'Send Broadcast',
    sending: 'Sending...',
    statistics: 'Statistics',
    targetContactCount: 'Target Contact Count',
    ...
    previewModal: 'Preview Broadcast Target',
    foundContacts: 'Found {count} matching contacts',
    close: 'Close',
    ...
    statusFailed: 'Failed',
    statusCancelled: 'Cancelled',
    sendSuccess: 'Broadcast started, targeting {count} contacts',
    sendError: 'Failed to send broadcast',
    previewError: 'Preview failed',
    cancelSuccess: 'Broadcast cancelled',
    cancelError: 'Failed to cancel broadcast',
    loadError: 'Failed to load options data',
    messageRequired: 'Please enter message content',
    groupOrTagRequired: 'Please select group or tag',
    name: 'Name',
    contact: 'Contact',
    company: 'Company',
    tags: 'Tags',
